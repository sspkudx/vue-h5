                ...
                <div class={styles.modalOverlay}>
                    <div class={styles.modal}>
                        ...
                        <div class={styles.modal__body}>
                            ...
                            {/* 具名插槽示例：自定义内容区域 */}
                            {slots.content && <div class={styles.modal__content}>{slots.content()}</div>}
...
const Button: FC<ButtonProps> = (props, { slots }) => {
    ...
    return (
        <button class={buttonClasses} onClick={handleClick} disabled={disabled || loading}>
            ...
            {/* 具名插槽示例：图标 */}
            {slots.icon && <span class={styles.button__icon}>{slots.icon()}</span>}
    ...
    <div class="dashboard">
        <header class="dashboard__header">
            ...
            <div class="dashboard__actions">
                <button @click="refresh" class="dashboard__refresh">Refresh</button>
            </div>
        </header>
